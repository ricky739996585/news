var listURL = "/kjz/articleLike/getAdminArticleLikeList";
var editURL = "/kjz/articleLike/editArticleLike";
$('#tableList').bootstrapTable({
	...
	uniqueId : "articleLikeId", // 每一行的唯一标识，一般为主键列
	showToggle : true, // 是否显示详细视图和列表视图的切换按钮
	cardView : false, // 是否显示详细视图
	detailView : false, // 是否显示父子表
	columns : [ 
		{field : "articleLikeId", title : "文章点赞编号"},
		...
		,{field : "operate", title : "操作",align: "center",
			formatter:function(value,row,index){
				var e = '<a href="/admin/kjz/addOrEditArticleLike.html?articleLikeId=' + row.articleLikeId + '" target="_blank" >编辑</a> ';
				return e;
			}
		}
	],
