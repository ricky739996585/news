var listURL = "/kjz/articleType/getAdminArticleTypeList";
var editURL = "/kjz/articleType/editArticleType";
	...
	columns : [ 
		...
		,{field : "operate", title : "操作",align: "center",
			formatter:function(value,row,index){
				var e = '<a href="/admin/kjz/addOrEditArticleType.html?typeId=' + row.typeId + '" target="_blank" >编辑</a> ';
				return e;
			}
		}
	],
