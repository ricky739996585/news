...
import com.kjz.www.utils.SensitiveWordInit;
 ...
 * @version 1.0
 */
@Component("sensitivewordFilterUtils")
public class SensitivewordFilterUtils {
	 ...
	 * 构造函数，初始化敏感词库
	 */
	public SensitivewordFilterUtils(){
	...
	public static void main(String[] args) {
		SensitivewordFilterUtils filter = new SensitivewordFilterUtils();
